...
Route::group(['prefix'=>'v1', 'namespace' => 'App\Http\Controllers'], function(){
    ...
    //Route::apiResource('media',mediaController::class); -> files
    ...
    //Route::apiResource('settings',SettingsController::class); -> admin
    //Route::apiResource('users',UserController::class); -> admin
    //Route::apiResource('user-roles',UserRoleController::class); -> admin
    ...
    Route::group(["prefix" => "admin"], function () {
        ...
        Route::group(["prefix" => "settings"], function () {
            ...
            Route::post('setting-optimize', [SettingsController::class, 'optimize'])->name('settings.optimize');
